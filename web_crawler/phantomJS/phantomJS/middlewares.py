...
class PhantomjsSpiderMiddleware(object):
...
class newMiddleware(object):
    def selenium_request(self, url):
        ...
        driver = webdriver.Chrome(chrome_options=chrome_options, executable_path="D:\coding\LinuxShare\chromedriver")
        driver.get(url)
