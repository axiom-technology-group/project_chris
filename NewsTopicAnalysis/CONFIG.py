class CONFIG():
    ...
    vocab_size = 4150         # 词汇量，与word2id中的词汇量一致
    n_class = 5                # 分类数：分别为10类具体分类
    max_sen_len = 150            # 句子最大长度
    ...
    num_filters = 16           # 卷积层filter的数量
    kernel_size = 5             # 卷积核的尺寸；nlp任务中通常选择2,3,4,5
    print_per_batch =16        # 训练过程中,每100词batch迭代，打印训练信息
