...
data = pd.read_table("./data/out.txt")
...
# print(data_half_1)
# # print(d)
data_half_1.to_csv('data/train.csv', index=False) # part 1
data_qua_1.to_csv('data/dev.csv', index=False) # part 2
data_qua_2.to_csv('data/test.csv', index=False) # part 2
