...
data = pd.read_table("./data/test1.txt")
label = data['标签']
# # 首先二等分
data_half_1, data_half_2, label_half_1, label_half_2 = \
    train_test_split(data, label, test_size=0.5, random_state=19970924)
#
# # 第一个子集二等分
...
# print(data_half_1)
# # print(d)
data_half_1.to_csv('data/dev.csv', index=False) # part 1
data_half_2.to_csv('data/test.csv', index=False) # part 2
